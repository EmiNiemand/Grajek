...
//    pointLight->GetComponent<PointLight>()->SetSpecular({0.9, 0.9, 0.9});
    ...
    backToPauseMenu->GetComponent<Button>()->LoadTexture(900, 500, "UI/buttonInactive.png", "UI/buttonActive.png");
    backToPauseMenu->GetComponent<Button>()->LoadFont("Back", 960, 525, 40);
    std::shared_ptr<GameObject> decreaseVolume = GameObject::Instantiate("DecreaseVolume", options);
    decreaseVolume->AddComponent<Button>();
    decreaseVolume->GetComponent<Button>()->LoadTexture(1000, 800, "UI/buttonSmallInactive.png", "UI/buttonSmallActive.png");
    decreaseVolume->GetComponent<Button>()->LoadFont("-", 1025, 815, 64);
    std::shared_ptr<GameObject> increaseVolume = GameObject::Instantiate("IncreaseVolume", options);
    increaseVolume->AddComponent<Button>();
    increaseVolume->GetComponent<Button>()->LoadTexture(1300, 800, "UI/buttonSmallInactive.png", "UI/buttonSmallActive.png");
    increaseVolume->GetComponent<Button>()->LoadFont("+", 1325, 815, 64);
    ...
    decreaseResolution->GetComponent<Button>()->LoadTexture(1000, 700, "UI/buttonSmallInactive.png", "UI/buttonSmallActive.png");
    decreaseResolution->GetComponent<Button>()->LoadFont("<", 1025, 715, 64);
    ...
    increaseResolution->GetComponent<Button>()->LoadTexture(1300, 700, "UI/buttonSmallInactive.png", "UI/buttonSmallActive.png");
    increaseResolution->GetComponent<Button>()->LoadFont(">", 1325, 715, 64);
    std::shared_ptr<GameObject> musicVolume = GameObject::Instantiate("MusicVolume", options);
    musicVolume->AddComponent<Text>();
    musicVolume->GetComponent<Text>()->LoadFont("Music Volume", 500, 800, 42);
    ...
    windowResolution->GetComponent<Text>()->LoadFont("Window Resolution", 500, 700, 42);
