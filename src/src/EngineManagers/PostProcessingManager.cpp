...
PostProcessingManager::PostProcessingManager() {
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, GL_RGB, GloomEngine::GetInstance()->width, GloomEngine::GetInstance()->height + 1, 0, GL_RGB, GL_UNSIGNED_BYTE, NULL);
    ...
    glRenderbufferStorage(GL_RENDERBUFFER, GL_DEPTH24_STENCIL8, GloomEngine::GetInstance()->width, GloomEngine::GetInstance()->height + 1); // use a single renderbuffer object for both a depth AND stencil buffer.
