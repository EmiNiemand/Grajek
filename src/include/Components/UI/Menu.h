...
public:
    ...
    std::shared_ptr<Button> AddButton(std::string name, int x, int y, const std::string& pathInactive, const std::string& pathActive, std::string text = "", FT_UInt fontSize = 18, glm::vec3 color = glm::vec3(0.0f, 0.0f, 0.0f), const std::string &fontPath = "Kanit-Light.ttf");
